...
# Define the query geometry (representing the "Connecting Ridge")
...
for idx, area in enumerate(intersection_areas):
    print(f"Area of intersection between {intersection_base_names[idx]} and the Connecting Ridge: {area}")
